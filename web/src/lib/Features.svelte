<script lang="ts">
    const pillars = [
        ...
        {
            n: "04",
            title: "EVM native. Sui anchored.",
            body: "Deploy standard EVM smart contracts with the tooling you already use. Every block settles on Sui with Walrus availability.",
        },
        {
            n: "05",
